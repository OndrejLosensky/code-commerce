...
export default function Layout ( { children } : Readonly<{children: React.ReactNode;}>){
    return (
            <main className="flex flex-col w-screen min-h-screen relative">
                <Link href="/admin" className="fixed bottom-4 bg-gradient-to-b from-violet-400 to-purple-400 rounded-full w-10 h-10 flex items-center justify-center z-10 right-4 border "> <RiAdminLine className="fill-white w-6 h-6"/> </Link>
